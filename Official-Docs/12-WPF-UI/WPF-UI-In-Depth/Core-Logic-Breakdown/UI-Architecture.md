...
- 3 state-bearing ViewModels using composition, not inheritance
- Full `CancellationToken` support for analysis, with export cancellation defined in the ViewModel (not currently bound to a UI button)
