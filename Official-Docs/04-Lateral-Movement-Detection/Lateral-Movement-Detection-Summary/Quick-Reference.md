...
> **WPF UI override:** The Advanced Options expander exposes an **Enable lateral movement detection** checkbox that overrides the profile value at analysis time. It defaults to checked/enabled for all intensities.
